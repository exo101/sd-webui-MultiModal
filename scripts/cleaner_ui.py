...
# 添加自定义CSS样式
custom_css = """
#xykc_cleanup_img2maskimg .touch-none {
...
#xykc_cleanup_img2maskimg .touch-none img {
...
/* 增强Sketchpad工具栏的可见性 */
.cleaner-canvas .image-container .brush-tools {
...
.cleaner-canvas .image-container .brush-tools button {
...
.cleaner-canvas .image-container .brush-tools button:hover {
    background-color: #555 !important;
}

.cleaner-canvas .image-container .brush-tools button.active {
    background-color: #007bff !important;
    border: 2px solid white !important;
}

.cleaner-canvas .image-container .brush-size-container {
    background-color: rgba(0, 0, 0, 0.7) !important;
    border-radius: 8px !important;
    padding: 5px !important;
    margin: 5px !important;
...
.cleaner-canvas .image-container .eraser-toolbar {
    background-color: rgba(0, 0, 0, 0.7) !important;
    border-radius: 8px !important;
    padding: 5px !important;
    margin: 5px !important;
...
/* 控制图像显示尺寸，确保图像适应容器 */
.cleaner-canvas .image-container img,
#xykc_cleanup_img2maskimg .image-container img {
    max-width: 100% !important;
    max-height: 100% !important;
...
/* 确保图像容器正确约束图像尺寸 */
.cleaner-canvas .image-container,
#xykc_cleanup_img2maskimg .image-container {
