...
def generate_image_with_zimage(prompt, negative_prompt, width, height, steps, cfg_scale, seed, sampler, batch_size, lora_enable, lora_model_1, lora_weight_1, lora_model_2, lora_weight_2, selected_model=None):
    """
    使用Z-Image正式版模型生成图像
    """
    try:
        ...
        for i, image in enumerate(images):
            ...
            filename = f"zimage_{timestamp}_s{seed}_{i}.png"
        ...
        return f"图像生成成功! 批次: {batch_size}, Seed: {seed}", saved_paths
