...
def generate_image_with_zimage_img2img(init_image, prompt, negative_prompt, width, height, steps, cfg_scale, seed, strength, batch_size, lora_enable, lora_model_1, lora_weight_1, lora_model_2, lora_weight_2, selected_model=None):
    """
    ...
    try:
        ...
        for i, image in enumerate(images):
            ...
            filename = f"zimage_img2img_{timestamp}_s{seed}_{i}.png"
        ...
        return f"图生图生成成功! 批次: {batch_size}, Seed: {seed}", saved_paths
