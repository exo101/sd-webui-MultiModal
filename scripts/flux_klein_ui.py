...
import json
import sys
import gradio as gr  # 添加 gradio 导入
from modules import shared
from modules import sd_samplers
from modules.ui_components import ToolButton
from modules import ui_common  # 导入 ui_common 模块
from modules import util  # 导入 util 模块
import requests
        ...
        with gr.TabItem("文生图"):
            ...
            if not FLUX_KLEIN_AVAILABLE:
                ...
                if STORYBOARD_AVAILABLE:
                    def send_gallery_to_storyboard(images):
                        """将画廊中的图片发送到分镜助手"""
