            ...
            with gr.Row():
                ...
                with gr.Column():  # 右侧面板 - 操作与输出
                    ...
                    extend_add_to_queue_btn.click(
                        fn=lambda image, prompt, steps, guidance_scale, seed, model_choice, batch_size, lora_enable, lora_model, lora_weight: (
                            add_to_queue('extend', image, prompt, steps, guidance_scale, seed, model_choice, batch_size, lora_enable, lora_model, lora_weight)
                        ),
                        inputs=[
                            extend_input, extend_prompt, 
                            extend_steps, extend_guidance_scale, extend_seed,
                            extend_model_choice, extend_batch_size,
