...
class NunchakuQwenImageTransformer2DModel(QwenImageTransformer2DModel, NunchakuModelLoaderMixin):
    ...
    **kwargs
    ...
    def __init__(self, *args, **kwargs):
        # 提取并保存pooled_projection_dim参数，确保它不会被忽略，并将其传递给父类
        pooled_projection_dim = kwargs.get("pooled_projection_dim", 768)  # 默认值为768
        self.pooled_projection_dim = pooled_projection_dim
        self.offload = kwargs.pop("offload", False)
        self.offload_manager = None
        self._is_initialized = False
        
        # 将 pooled_projection_dim 添加到 kwargs 中，确保父类能接收到
        kwargs["pooled_projection_dim"] = pooled_projection_dim
