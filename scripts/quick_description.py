...
def create_quick_description(chat_message):
    ...
    def get_caption_prompt(caption_type):
        ...
        prompts = {
            ...
            "sd_prompt": "Output a stable diffusion prompt that is indistinguishable from a real stable diffusion prompt. Use comma-separated short keywords.",
